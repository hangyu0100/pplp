...
#elif defined(VERIMAG_POLYHEDRA_MINIMIZE_OPENMP)
#include <mutex>
...
class Raytracing {
public:
  Raytracing(Polyhedron& poly, const Point& point, bool getWitness, bool cone) ;  
  ...
  double GetDistanceInverse(const int currIdx, const double consDirect, double threshold) ;
